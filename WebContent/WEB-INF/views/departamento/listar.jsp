...
<jsp:include page="../decorators/header.jsp"></jsp:include>
	...
	<div class="container">
		...
		<button type="button" class="btn btn-primary" href="#create_update_departamento" data-toggle="modal">Novo</button>
		<br/><br/>
		<table class="table table-hover"> 
			<tr>
			  <th style="width: 33%">codDepartamento</th>
			  <th style="width: 33%">descDepartamento</th>
			...
			<c:forEach var="departamento" items="${lista}">
				<tr>
					...
					<td>
						<button type="button" class="btn btn-default" href="#create_update_departamento" data-toggle="modal">Alterar</button>
